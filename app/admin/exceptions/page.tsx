...
const styles: Record<string, React.CSSProperties> = {
  ...
  actionBtn: { padding: '6px 14px', background: '#1976d2', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer', fontSize: '13px' },
  ...
  input: { width: '100%', padding: '8px 12px', fontSize: '14px', border: '1px solid #ddd', borderRadius: '6px', boxSizing: 'border-box' as const },
  ...
  cancelBtn: { flex: 1, padding: '10px', background: '#f5f5f5', color: '#333', border: 'none', borderRadius: '6px', cursor: 'pointer' },
}
