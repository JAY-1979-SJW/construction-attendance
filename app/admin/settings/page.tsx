          ...
          <>
            ...
            <div style={s.card}>
              <div style={s.cardHeader}>
                ...
                {!isPro && (
                  <span style={s.proBadge}>유료 전용</span>
                )}
              </div>
                ...
                <div style={s.fieldList}>
                  ...
                  {form.enabled && (
                    <>
                      ...
                      <ToggleRow
                        label="오전 랜덤 확인"
                        desc="09:30 ~ 11:30 구간에서 랜덤 1회 알림"
                      ...
                      <ToggleRow
                        label="오후 랜덤 확인"
                        desc="13:30 ~ 16:30 구간에서 랜덤 1회 알림"
              ...
              {isPro && canMutate && (
                <div style={{ padding: '0 24px 24px' }}>
                  {msg && (
                    <div style={{ ...s.msgBox, background: msg.type === 'success' ? '#e8f5e9' : msg.type === 'warn' ? '#fff8e1' : '#fff5f5', color: msg.type === 'success' ? '#2e7d32' : msg.type === 'warn' ? '#e65100' : '#c62828' }}>
                      {msg.text}
                    </div>
                  )}
            ...
            <div style={s.helpCard}>
              ...
              <div style={s.helpItem}>· 오전/오후 랜덤 시각에 체류 확인 알림이 발생합니다.</div>
              <div style={s.helpItem}>· 근로자가 확인 버튼을 누르면 현재 위치가 현장 반경 내인지 검사합니다.</div>
              <div style={s.helpItem}>· 실패 또는 미응답 건은 검토 대상으로 분류될 수 있습니다.</div>
              <div style={s.helpItem}>· 설정 변경은 다음 스케줄 생성 시점부터 반영됩니다.</div>
            </div>
          </>
        )}
      </main>
