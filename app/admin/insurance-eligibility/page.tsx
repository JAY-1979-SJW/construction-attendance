                  ...
                  {items.length === 0 ? (
                    ...
                    <tr key={item.id} style={s.tr}>
                      ...
                      <td style={s.td}>
                        ...
                        <div style={{ fontSize: '11px', color: '#888', marginTop: '2px' }}>{item.nationalPensionReason ?? ''}</div>
                      </td>
                      <td style={s.td}>
                        {check(item.healthInsuranceEligible)}
                        <div style={{ fontSize: '11px', color: '#888', marginTop: '2px' }}>{item.healthInsuranceReason ?? ''}</div>
                      </td>
                      <td style={s.td}>
                        {check(item.employmentInsuranceEligible)}
                        <div style={{ fontSize: '11px', color: '#888', marginTop: '2px' }}>{item.employmentInsuranceReason ?? ''}</div>
                      </td>
                      <td style={s.td}>
