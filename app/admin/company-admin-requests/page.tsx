...
const s: Record<string, React.CSSProperties> = {
  ...
  resultBox:  { background: '#e3f2fd', border: '1px solid #90caf9', borderRadius: '8px', padding: '16px', marginBottom: '16px', fontSize: '14px' },
  code:       { display: 'block', fontFamily: 'monospace', fontSize: '18px', fontWeight: 700, margin: '8px 0', color: '#1565c0', letterSpacing: '0.1em' },
  ...
  sub:        { fontSize: '11px', color: '#888', marginTop: '2px' },
  ...
  modal:      { background: 'white', borderRadius: '12px', padding: '28px', width: '440px', boxShadow: '0 8px 32px rgba(0,0,0,0.15)' },
  ...
  textarea:   { width: '100%', padding: '10px', border: '1px solid #ddd', borderRadius: '8px', fontSize: '14px', boxSizing: 'border-box' as const, resize: 'vertical' as const },
