...
const s: Record<string, React.CSSProperties> = {
  ...
  select:       { padding: '8px 12px', border: '1px solid #ddd', borderRadius: '8px', fontSize: '13px', background: 'white' },
  cards:        { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: '14px', marginBottom: '24px' },
  card:         { background: 'white', borderRadius: '10px', padding: '16px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' },
  ...
  th:           { textAlign: 'left', padding: '9px 12px', fontSize: '12px', color: '#888', borderBottom: '2px solid #f0f0f0', whiteSpace: 'nowrap' },
  td:           { padding: '10px 12px', fontSize: '13px', borderBottom: '1px solid #f5f5f5', whiteSpace: 'nowrap' },
  tr:           {},
  todayBadge:   { marginLeft: '6px', fontSize: '11px', background: '#e3f2fd', color: '#1565c0', padding: '1px 6px', borderRadius: '8px' },
