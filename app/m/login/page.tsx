  ...
  if (!role) return (
    <div className="px-5 py-8">
      ...
      <div className="flex items-center gap-3 my-5">
        <div className="flex-1 h-px bg-gray-200" /><span className="text-[12px] text-gray-400">소셜 계정으로 바로 로그인</span><div className="flex-1 h-px bg-gray-200" />
      </div>
      ...
      <p className="text-center text-[12px] text-gray-400 mt-4">소셜 로그인은 근로자 계정으로 연결됩니다</p>
