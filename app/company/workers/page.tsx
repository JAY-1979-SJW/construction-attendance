...
const styles: Record<string, React.CSSProperties> = {
  ...
  searchInput: { padding: '9px 12px', border: '1px solid #ddd', borderRadius: '7px', fontSize: '14px', width: '220px', outline: 'none' },
  ...
  modal: { background: 'white', borderRadius: '12px', padding: '32px', width: '100%', maxWidth: '420px', boxShadow: '0 8px 40px rgba(0,0,0,0.2)' },
  ...
  input: { width: '100%', padding: '10px 12px', fontSize: '14px', border: '1px solid #ddd', borderRadius: '7px', outline: 'none', boxSizing: 'border-box' as const },
  select: { width: '100%', padding: '10px 12px', fontSize: '14px', border: '1px solid #ddd', borderRadius: '7px', outline: 'none', background: 'white', boxSizing: 'border-box' as const },
