    ...
    <div className="min-h-screen bg-[#F5F7FA] flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl px-8 py-9 w-full max-w-[440px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] border border-[#E5E7EB] border-t-[3px] border-t-[#F97316] text-center">
        ...
        <div className="text-left mb-6">
          <h2 className="text-[14px] font-bold text-[#111827] mb-3">필수 서류 안내</h2>
          <div className="space-y-[10px]">
            {[
              ...
              <div key={doc.name} className="flex items-start gap-[10px] bg-[#F9FAFB] border border-[#E5E7EB] rounded-lg px-3 py-[10px]">
                <span className="text-[16px] leading-none mt-[1px] shrink-0">
                  {doc.status === 'done' ? '✅' : doc.status === 'later' ? '⏳' : '📄'}
                </span>
                <div className="min-w-0">
                  <div className="text-[13px] font-semibold text-[#111827]">{doc.name}</div>
