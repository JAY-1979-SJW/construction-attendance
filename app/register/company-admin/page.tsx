...
const s: Record<string, React.CSSProperties> = {
  ...
  btn:         { display: 'block', width: '100%', padding: '14px', background: '#1565c0', color: 'white', border: 'none', borderRadius: '10px', fontSize: '16px', fontWeight: 700, cursor: 'pointer', marginTop: '8px' },
